          ...
          <Tooltip>
            <TooltipTrigger as-child>
              <a
                ...
                class="inline-flex items-center justify-center w-9 h-9 rounded-lg text-[var(--app-text-secondary)] hover:text-[var(--app-primary)] hover:bg-[var(--app-primary)]/10 transition-colors"
              >
